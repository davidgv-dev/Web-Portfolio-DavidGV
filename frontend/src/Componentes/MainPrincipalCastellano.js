    ...
    <main>
      <div className="contenedor-principal"> 
        <div> 
          ...
          <p className="text">Las herramientas que principalmente uso son JavaScript, React, Laravel y PHP, así como otros recursos véase Git, Docker, AWS o Firebase; utilizo todas estas, junto a una gran atención al detalle a la hora de manipular los lenguajes de marcado y estilo.</p> <p className="text">Ahora mismo estoy trabajando con <a href="https://dormisfera.com/" target="_blank" rel="noopener noreferrer" className="dormisfera-link">Dormisfera</a>, realizando de manera autónoma una landing page personalizada y escalable. Tengo un nivel de Inglés profesional, me considero una persona organizada, responsable y atenta, así como me siento atraído hacia la expresión artística y sus fundamentos teóricos estilísticos (color, balance, expresión, variedad, etcétera).</p> 
